...
// i sorta stole this from the bogus mod... um... play their mod so i dont fell bad *sweats* https://gamebanana.com/mods/317381

class MP4State extends FlxUIState
{
    public static var videoName:String = 'test';
